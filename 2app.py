...
st.warning("💳 **Fee Notice (ONLY APPILIES FOR GENERAL/CSS STUDENTS WANTING TO ENROLL IN ONE MONTH FREE CLASSES):** Kindly deposit your ONE TIME  registration fee (1000 RUPEES) into the **EasyPaisa Account: 03365464411 ACCOUNT NAME : MUHAMMAD AKRAM ** after filling out your details.")
st.write("---")
